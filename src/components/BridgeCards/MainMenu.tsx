...
export const MainMenu: React.FC<MainMenuProps> = ({
  ...
  const getButtonClasses = (
    ...
    const isActive =
      lastPlayedMode === mode || (!lastPlayedMode && mode === "realPartner");
    ...
    return {
      container:
        "w-full bg-white hover:shadow-lg rounded-2xl p-6 text-left transition-all border border-slate-100 group",
  ...
  const warmupStyle = getButtonClasses(
    "warmup",
    "text-blue-500",
  ...
  const aiPartnerStyle = getButtonClasses(
    "partner",
    "text-purple-500",
  ...
  const realPartnerStyle = getButtonClasses(
    "realPartner",
    "text-rose-500",
  ...
  const voicePracticeStyle = getButtonClasses(
    "voicePractice",
    "text-indigo-500",
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-slate-50 p-6 flex items-center justify-center">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="mb-4">
          <p className="text-xs font-bold text-slate-400 tracking-wider uppercase text-center md:text-left ml-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className={warmupStyle.subtitle}>
                    Solo practice • Vocabulary & Grammar
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className={aiPartnerStyle.subtitle}>
                    AI Practice • Speaking & Responses
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className={realPartnerStyle.iconWrapper}>
                  <Users
                    className={
                      lastPlayedMode === "realPartner" || !lastPlayedMode
                        ? "text-white"
                        : "text-rose-500"
                    }
                    size={24}
                ...
                <div>
                  ...
                  <p className={realPartnerStyle.subtitle}>
                    Practice with a friend face-to-face
                  </p>
                </div>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className={voicePracticeStyle.title}>
                    AI Voice Practice
                  </h2>
                  <p className={voicePracticeStyle.subtitle}>
                    Conversation with Ze AI
                  </p>
                </div>
              </div>
